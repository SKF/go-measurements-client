...
type ModelMediaMetaData struct {
	...
	// This is the ID of the media file
	// Format: uuid
...
func (m *ModelMediaMetaData) validateID(formats strfmt.Registry) error {
...
// ModelMediaMetaDataDimensions model media meta data dimensions
//
// swagger:model ModelMediaMetaDataDimensions
...
// Validate validates this model media meta data dimensions
