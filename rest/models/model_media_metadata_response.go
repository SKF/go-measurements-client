...
func (m *ModelMediaMetadataResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelMediaMetadataResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *ModelMediaMetadataResponse) UnmarshalBinary(b []byte) error {
	var res ModelMediaMetadataResponse
